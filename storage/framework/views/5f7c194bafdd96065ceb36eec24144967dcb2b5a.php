    ...
    <div>
        ...
        <div style="text-align: justify">
            <div style="text-align: right">
                Asunción, <?php echo e(date('d', strtotime($data['created_at']))); ?> de <?php echo e($meses[date('m', strtotime($data['created_at'])) - 1]); ?> de <?php echo e(date('Y', strtotime($data['created_at']))); ?>
            ...
            <br /><br />
            Monto: <span class="text"><?php echo e(number_format($data->amount, 0, '.', '.')); ?></span> Gs. seg. Resolución N° <span class="text">-</span>
            <br /><br />
