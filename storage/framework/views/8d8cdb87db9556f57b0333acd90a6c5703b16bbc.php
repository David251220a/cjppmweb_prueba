            ...
            <div class="flex items-center justify-between">
                <div>
                    <a href="<?php echo e(route('home')); ?>">
                        <img src="<?php echo e(Storage::url('logo.png')); ?>" class="h-10 md:h-16" alt="">
                    </a>
                </div>
                ...
                <div class="hidden md:block">
                    <a class="flex items-center space-x-4 bg-primary cursor-pointer text-white rounded shadow px-4 py-2" href="<?php echo e(route('portal')); ?>">
            ...
            <div class="md:container">
                <div class="flex justify-between">
                    <div class="hidden md:flex flex-row">
                        <a class="block px-4 py-3 hover:bg-primary" href="<?php echo e(route('home')); ?>">Inicio</a>
                        <a class="block px-4 py-3 hover:bg-primary" href="<?php echo e(route('institutional')); ?>">Institucional</a>
                        <a class="block px-4 py-3 hover:bg-primary" href="<?php echo e(route('institutional.authorities')); ?>">Autoridades</a>
                        <a class="block px-4 py-3 hover:bg-primary" href="<?php echo e(route('institutional.departments')); ?>">Direcciones</a>
                        <a class="block px-4 py-3 hover:bg-primary" href="<?php echo e(route('institutional.history')); ?>">Historia</a>
                        <a class="block px-4 py-3 hover:bg-primary" href="<?php echo e(route('institutional.social')); ?>">Sede Social</a>
                        <a class="block px-4 py-3 hover:bg-primary" href="<?php echo e(route('institutional.medical')); ?>">Servicio Médico</a>
                        <a class="block px-4 py-3 hover:bg-primary" href="<?php echo e(route('wnews')); ?>">Noticias</a>
                        <a class="block px-4 py-3 hover:bg-primary" href="<?php echo e(route('wley5189')); ?>">Ley 5189</a>
                        <a class="block px-4 py-3 hover:bg-primary" href="<?php echo e(route('wley2991')); ?>">Decreto 2991/19</a>
                        <a class="block px-4 py-3 hover:bg-primary" href="<?php echo e(route('contact')); ?>">Contáctanos</a>
                    </div>
                ...
                <div class="flex items-center justify-between font-semibold text-xs">
                    ...
                    <div class="hidden md:block">
                        <ul class="flex items-center gap-4 list-none">
                            <li><a class="text-green-200 hover:text-primary" href="<?php echo e(route('home')); ?>">Inicio</a></li>
                            <li><a class="text-green-200 hover:text-primary" href="<?php echo e(route('institutional')); ?>">Institucional</a></li>
                            <li><a class="text-green-200 hover:text-primary" href="<?php echo e(route('wnews')); ?>">Noticias</a></li>
                            <li><a class="text-green-200 hover:text-primary" href="<?php echo e(route('contact')); ?>">Contáctanos</a></li>
                            <li><a class="text-green-200 hover:text-primary" href="<?php echo e(route('portal')); ?>">Portal de Autogestión</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\cjppm_web\resources\views/layouts/www.blade.php ENDPATH**/ ?>