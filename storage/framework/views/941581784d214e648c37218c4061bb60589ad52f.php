<div style="font-family: Arial, Helvetica, sans-serif; font-size:13px; line-height:24px;">
    ...
    <div>
        ...
        <div style="text-align: justify; margin-top: 0;margin-bottom: 30px;  font-size: 15px">
            ...
            En fecha comparece ante mi <span><b><?php echo e($affiliate->name); ?></b></span> <span><b><?php echo e($affiliate->lastname); ?></b></span>
            <br>
            Con Cédula de Identidad Nº: <span><b><?php echo e(number_format($affiliate->document_number, 0, ".", ".")); ?></b></span>, y manifiesta que vive y
            reside en el domicilio: <span><b><?php echo e($affiliate->address[0]->address); ?></b></span>
            <br>
            Del barrio: <span><b><?php echo e($affiliate->address[0]->neighborhood); ?></b></span> de la ciudad: <span><b><?php echo e($affiliate->address[0]->city); ?></b></span>
        ...
        <div style="text-align: justify; margin-top: 0;margin-bottom: 5px;  font-size: 15px">
            ...
            <p style="margin-top: 5;margin-bottom: 5px;margin-left: 50px; font-size: 15px">
                Nombre y Apellido:  <b><span><?php echo e($affiliate->censo->encargado); ?></span></b>
            </p>            
            <p style="margin-top: 0;margin-bottom: 5px;margin-left: 50px; font-size: 15px">                
                C.I. Nro.:  <b><span><?php echo e((empty($affiliate->censo->documento_encargado) ? null : number_format($affiliate->censo->documento_encargado, 0, ".", "."))); ?></span></b>
            </p>
            <p style="margin-top: 0;margin-bottom: 5px;margin-left: 50px; font-size: 15px">                
                Nro. de Teléfono:  <b><span><?php echo e($affiliate->censo->numero_telefono_encargado); ?></span></b>
            </p>
            <?php
                $parentesco = '';    
            ?>
            ...
            <?php if(!empty($affiliate->censo->parentesco)): ?>
                ...
                <?php if($affiliate->censo->parentesco == 1): ?>
                    <?php
                        $parentesco = 'HIJO/A'
                    ?>
                <?php endif; ?>
                <?php if($affiliate->censo->parentesco == 2): ?>
                    <?php
                        $parentesco = 'HERMANO/A'
                    ?>
                <?php endif; ?>
                <?php if($affiliate->censo->parentesco == 3): ?>
                    <?php
                        $parentesco = 'NIETO/A'
                    ?>
                <?php endif; ?>
                <?php if($affiliate->censo->parentesco == 4): ?>
                    <?php
                        $parentesco = 'OTRO'
                    ?>
                <?php endif; ?>
            ...
            Revistiendo ésta manisfestación con caracter de declaración jurada, en fecha: <b><?php echo e(date('d/m/Y', strtotime($affiliate->censo->updated_at ))); ?></b>
        </div>
        ...
        <div style="text-align: justify; margin-top: 40px;margin-bottom: 0px;  font-size: 15px">
            ...
            <br>
            Tel./Cel.: <?php echo e((empty($affiliate->celular) ? null : '0'. substr($affiliate->celular, 3 ,10))); ?>
        ...
        <div style="text-align: right; margin-top: 0;margin-bottom: 10px;  font-size: 15px">
            ...
            <p style="margin-top: 0px; margin-bottom: 0px;margin-right: 0px"> <u>__________<?php echo e(@Auth::user()->name); ?> <?php echo e(@Auth::user()->lastname); ?>__________</u></p>
            <p style="margin-top: 0px; margin-bottom: 0px;margin-right: 100px"> Ante mí</p>
        </div>
        ...
        <div style="text-align: justify; margin-top: 20px; margin-bottom: 0px;  font-size: 15px">
            ...
            Se deja constancia que el/la jubilado/a pensionado/a <span><b><?php echo e($affiliate->name); ?></b></span> <span><b><?php echo e($affiliate->lastname); ?></b></span>
            presentó en fecha <span><b><?php echo e(date('d/m/Y', strtotime($affiliate->censo->updated_at ))); ?></b></span> su Declaración Jurada de domicilio.
...
</div><?php /**PATH C:\laragon\www\cjppm_web\resources\views/jubilacion/show.blade.php ENDPATH**/ ?>